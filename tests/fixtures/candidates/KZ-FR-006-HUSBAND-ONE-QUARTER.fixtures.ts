...
export const KZ_FR_006_HUSBAND_ONE_QUARTER_FIXTURES = defineAtomicSpouseFixtures([
  ...
  {
    fixtureId: "KZ-FR-006-HUSBAND-ONE-QUARTER-BOUNDARY-SONS-DAUGHTER",
    relevantRuleId: "KZ-FR-006-HUSBAND-ONE-QUARTER",
    heirInputs: [
      { category: "husband", count: 1 },
      { category: "son's daughter", count: 1 },
    ],
    requiredConditions: ["A normalized son's daughter is a qualifying descendant."],
